...
See L<http://dev.galileo.usg.edu/table_maker.html> for demonstrations
...
This function turns an <ol> tag (or a <ul> tag) into a table.  Each
...
that assigns a to number that item.  Subsequent items
